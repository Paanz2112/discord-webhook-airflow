...
import sys
sys.path.insert(1, '/home/maholan/discord-airflow')
...
def task_success_alert(context):
    ...
    sendAlert(dag_id=dag_id,task_id=task_id,dag_state=dag_state,exec_date=exec_date,end_date=end_date,job_id_=job_id_,dag_duration=dag_duration)
